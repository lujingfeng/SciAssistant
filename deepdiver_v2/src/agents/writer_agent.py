...
from .prompt.writer_prompt import WRITER_SYSTEM_PROMPT_TEMPLATE
from .prompt.writer_prompt_zh import WRITER_SYSTEM_PROMPT_TEMPLATE_ZH
...
class WriterAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        ...
        system_prompt_template = WRITER_SYSTEM_PROMPT_TEMPLATE_ZH
