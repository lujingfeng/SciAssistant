...
from .prompt.objective_information_seeker_prompt import OBJECTIVE_INFORMATION_SEEKER_SYSTEM_PROMPT_TEMPLATE
from .prompt.objective_information_seeker_prompt_zh import OBJECTIVE_INFORMATION_SEEKER_SYSTEM_PROMPT_TEMPLATE_ZH
...
class InformationSeekerAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        ...
        system_prompt_template = OBJECTIVE_INFORMATION_SEEKER_SYSTEM_PROMPT_TEMPLATE_ZH
